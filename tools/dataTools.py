...
def add_bhv(trial_data, bhv_fields = ["all"]):
    if bhv_fields[0] == "all":
        bhv_fields = [
                'calibrated_eyes_pos',"left_hand_pos","tail_pos",
                'eye_acceleration', 'eye_azimuth', 'eye_direction',
                'eye_distance_traveled', 'eye_eccentricity', 'eye_grid_ID',
                'eye_velocity', 
                'eyebrow_pos', 'head_pos',
                'eyes_pos',
                'head_acceleration', 'head_direction', 'head_distance_traveled',
                'head_grid_ID', 'head_velocity',
                'head_tilt',
                'nose_pos', 'pupil_size', 
                'right_hand_pos', 
                'Motion_energy_arm', 'Motion_energy_head'
                    ]
...
def get_data_array_and_pos(data_list: list[pd.DataFrame], trial_cat,epoch , area: str ='PFC', n_components: int =10, normalize_pos = False,model = None, n_neighbors = 10,pca_bhv = False, bhv = ["all"]) -> np.ndarray:
    """
